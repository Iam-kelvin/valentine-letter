...
const occasionSections = [
  {
    title: "Core",
    keys: ["love", "appreciation", "just-because", "birthday", "congratulations"],
  },
  {
    title: "Special Days",
    keys: ["mothers-day", "fathers-day", "womens-day"],
  },
  {
    title: "Emotional",
    keys: ["apology", "closure", "miss-you", "ex", "confession"],
  },
  {
    title: "Unfiltered",
    keys: ["cheeky", "situationship"],
  },
  {
    title: "Personal",
    keys: ["friend", "faith", "thank-you"],
  },
] as const;
        ...
        <div className="grid gap-12">
          {occasionSections.map((section) => (
            <section key={section.title}>
              <h2 className="text-sm font-semibold uppercase tracking-[0.22em] text-rose-200/70">
                {section.title}
              </h2>
